...
public class ChooseLanguage extends Panel {
    ...
    @Autowired
    private VaadinMessageSource msg;

    @PostConstruct
    public void PostConstruct() {
        setCaption(msg.getMessage("choose_language.select_lang"));
        ...
        Button russian = new Button(msg.getMessage("choose_language.russian"), new Button.ClickListener() {
            @Override
        ...
        Button english = new Button(msg.getMessage("choose_language.english"), new Button.ClickListener() {
            @Override
            public void buttonClick(Button.ClickEvent event) {
        ...
        Button german = new Button(msg.getMessage("choose_language.german"), new Button.ClickListener() {
            @Override
            public void buttonClick(Button.ClickEvent event) {
        ...
        Button finnish = new Button(msg.getMessage("choose_language.finnish"), new Button.ClickListener() {
            @Override
            public void buttonClick(Button.ClickEvent event) {
