...
@Component
@Scope("prototype")
public class UiMedicalServiceCreateServiceView extends BasePopup<UiMedicalServiceCreateServiceViewModel> {

    @Autowired UiMedicalServiceCreateServiceViewModel model;

    @Override
    public UiMedicalServiceCreateServiceViewModel getModel() {
        return model;
    }
