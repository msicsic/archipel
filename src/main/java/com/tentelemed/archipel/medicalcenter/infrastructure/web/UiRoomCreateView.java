...
@Component
@Scope("prototype")
public class UiRoomCreateView extends BasePopup<UiRoomCreateViewModel> {

    @Autowired UiRoomCreateViewModel model;

    public UiRoomCreateView() {
    }

    @Override
    public UiRoomCreateViewModel getModel() {
        return model;
    }
